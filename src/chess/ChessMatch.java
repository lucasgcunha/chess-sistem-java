...
public class ChessMatch {
    ...
    private void validateSourcePosition(Position pos){
        ...
        if(currentPlayer != ((ChessPiece) board.piece(pos)).getColor()) throw new ChessException("The chosen piece is not yours");
        if(!board.piece(pos).isThereAnyPossibleMove()) throw new ChessException("There is no possible moves for the chosen piece");
